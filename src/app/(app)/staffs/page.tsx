...
export default async function StaffsPage() {
  ...
  const members = all<{ user_id: string; role: string; status: string; joined_at: string; name: string; email: string; permissions: string | null }>(
    `SELECT m.user_id, m.role, m.status, m.joined_at, m.permissions, u.name, u.email
